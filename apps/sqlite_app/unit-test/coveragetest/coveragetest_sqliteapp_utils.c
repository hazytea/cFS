...
void Test_TEMPLATE_APP_TblValidationFunc(void)
{
    /*
     * Test Case For:
    ...
    UtAssert_INT32_EQ(TEMPLATE_APP_TblValidationFunc(&TestTblData), CFE_SUCCESS);

    /* error case should return TEMPLATE_APP_TABLE_OUT_OF_RANGE_ERR_CODE */
    TestTblData.Int1 = 1 + TEMPLATE_APP_TBL_ELEMENT_1_MAX;
    UtAssert_INT32_EQ(TEMPLATE_APP_TblValidationFunc(&TestTblData), TEMPLATE_APP_TABLE_OUT_OF_RANGE_ERR_CODE);
}

void Test_TEMPLATE_APP_GetCrc(void)
{
    /*
     * Test Case For:
...
{
    ADD_TEST(TEMPLATE_APP_TblValidationFunc);
    ADD_TEST(TEMPLATE_APP_GetCrc);
}
