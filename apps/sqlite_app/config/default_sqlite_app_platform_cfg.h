 ...
 * @file
 *
 * SQLITE_APP Application Platform Configuration Header File
 *
 ...
 * dictionary tool.
 */
#ifndef SQLITE_APP_PLATFORM_CFG_H
#define SQLITE_APP_PLATFORM_CFG_H

#include "sqlite_app_mission_cfg.h"
#include "sqlite_app_internal_cfg.h"
